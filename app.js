...
document.addEventListener('DOMContentLoaded', function () {
    // Dummy data for courses, lessons, and quizzes
    const courses = [
      { id: 1, name: 'Mathematics', instructor: 'Saad Latif' },
      { id: 2, name: 'Geometry Fundamentals', instructor: 'Jane Smith' },
      { id: 3, name: 'Computer Programming', instructor: 'Harry' },
     
      // Add more courses as needed
    ];
  
    const lessons = [
      { id: 1, title: 'Algebra Basics', videoUrl: 'https://youtu.be/c7K2SM7TzE4?t=2' },
      { id: 2, title: 'Geometry Fundamentals', videoUrl: 'https:youtu.be/k5etrWdIY6o?list=PLUPEBWbAHUsxuIbsAS--B6cobarm2bty2&t=11'},
      { id: 3, title: 'English', videoUrl: 'https://youtu.be/spD09_W6lPg?t=1'},
     
      // Add more lessons as needed
    ];
  
    const quizzes = [
      { id: 1, title: 'Algebra Quiz', questions: ['Q1', 'Q2', 'Q3'] },
      { id: 2, title: 'Geometry Quiz', questions: ['Q1', 'Q2', 'Q3'] },
    ...
    lessons.forEach(lesson => {
      const row = lessonTable.insertRow();
      row.insertCell(0).textContent = lesson.id;
      row.insertCell(1).textContent = lesson.title;
      row.insertCell(2).innerHTML = `<a href="${lesson.videoUrl}" target="_blank">Watch Video</a>`;
    });
    ...
    quizzes.forEach(quiz => {
      ...
      row.insertCell(0).textContent = quiz.id;
      row.insertCell(1).textContent = quiz.title;
      row.insertCell(2).textContent = quiz.questions.join(', ');
    });
